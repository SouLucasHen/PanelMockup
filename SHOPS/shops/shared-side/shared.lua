...
List = {
	...
	Dismantle = {
		Name = "Desmanche",
		Description = "Troque suas limas de ferro por materiais de desmanche.",
		Mode = "Buy",
		Type = "Consume",
		Item = "ironfilings",
		List = {
	...
	Ammunation = {
		Name = "Ammu-Nation",
		Description = "Armas brancas para a sua defesa pessoal.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			WEAPON_HATCHET = 975,
	...
	Departament = {
		Name = "Departamento",
		Description = "Mercados e conveniências espalhados pela cidade.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			postit = 20,
	...
	Eletronics = {
		Name = "Eletrônicos",
		Description = "Equipamentos eletrônicos e de comunicação.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			radio = 975,
	...
	Coffee = {
		Name = "Café",
		Description = "Café fresquinho para começar o dia.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			coffeecup = 20
	...
	Soda = {
		Name = "Refrigerantes",
		Description = "Bebidas geladas para matar a sede.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			cola = 20,
	...
	Donut = {
		Name = "Donuts",
		Description = "Donuts e chocolates deliciosos.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			donut = 15,
	...
	Hamburger = {
		Name = "Hamburgueria",
		Description = "Hambúrgueres artesanais na hora.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			hamburger = 25
	...
	Hotdog = {
		...
		Description = "O clássico cachorro-quente de rua.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			hotdog = 20
	...
	Chihuahua = {
		Name = "Chihuahua",
		Description = "Lanche rápido completo em um só lugar.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			hotdog = 20,
	...
	Water = {
		Name = "Água",
		Description = "Água mineral para se hidratar.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			water = 35
	...
	Cigarette = {
		Name = "Tabacaria",
		Description = "Cigarros e isqueiros.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			cigarette = 15,
	...
	Paramedico = {
		Name = "Farmácia",
		Description = "Materiais médicos para emergências.",
		Mode = "Buy",
		Type = "Cash",
	...
	Hunting = {
		Name = "Caça",
		Description = "Venda as carcaças da sua caçada.",
		Mode = "Sell",
		Type = "Cash",
		List = {
			boar1star = 275,
	...
	Hunting2 = {
		Name = "Caça & Equipamentos",
		Description = "Equipamentos e rações para caçadores.",
		Mode = "Buy",
		Type = "Cash",
		List = {
			ration = 125,
	...
	Miners = {
		Name = "Mineradores",
		Description = "Venda os seus minérios refinados.",
		Mode = "Sell",
		Type = "Cash",
		List = {
			tin_pure = 40,
	...
	Policia = {
		...
		Description = "Equipamentos policiais autorizados.",
		Mode = "Buy",
		Type = "Cash",
		Permission = "Policia",
		List = {
