...
-- ADDMENU
-----------------------------------------------------------------------------------------------------------------------------------------
exports("AddMenu",function(Title,Description,Id,ParentId,Image)
	SendNUIMessage({ Action = "AddMenu", Payload = { Title = Title, Description = Description, Id = Id, ParentId = ParentId, Image = Image } })
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- ADDPROGRESS
-----------------------------------------------------------------------------------------------------------------------------------------
exports("AddProgress",function(Title,Description,Value,ParentId)
	SendNUIMessage({ Action = "AddProgress", Payload = { Title = Title, Description = Description, Value = Value, ParentId = ParentId } })
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- DYNAMIC:ADDPROGRESS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("dynamic:AddProgress")
AddEventHandler("dynamic:AddProgress",function(Title,Description,Value,ParentId)
	SendNUIMessage({ Action = "AddProgress", Payload = { Title = Title, Description = Description, Value = Value, ParentId = ParentId } })
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- DYNAMIC:ADDBUTTON
...
-----------------------------------------------------------------------------------------------------------------------------------------
-- DYNAMIC:ADDMENUIAMGE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("dynamic:AddMenuImage")
AddEventHandler("dynamic:AddMenuImage",function(Title,Description,Id,ParentId,Image)
	SendNUIMessage({ Action = "AddMenu", Payload = { Title = Title, Description = Description, Id = Id, ParentId = ParentId, Image = Image } })
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- OPEN
